...
| env.preview    | `db-agent-preview`                          | same                      | same                                                     | `auth-agent-preview`                                                     | `cloudflarebase_db_events_preview` | `DEMO_MODE:"true"`, `DEMO_TTL_HOURS:"720"`, `TRUSTED_ORIGINS:"https://cloudflarebase-com-preview.cloudflarebase.workers.dev"`, preview `SENTRY_DSN`                   |                                               |
