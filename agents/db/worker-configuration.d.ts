/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b21189604fc827e696a40b2a33ceeff)
// Runtime types generated with workerd@1.20260730.1 2026-07-10 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	...
	TRUSTED_ORIGINS: "https://cloudflarebase.com" | "http://localhost:5173,http://127.0.0.1:5173,http://localhost:8789" | "http://localhost:8797,http://127.0.0.1:8797" | "https://preview-cloudflarebase-com.cloudflarebase.workers.dev" | "";
	DbAgent: DurableObjectNamespace<import("./src/index").DbAgent>;
	DbCollection: DurableObjectNamespace<import("./src/index").DbCollection>;
	DbTable: DurableObjectNamespace<import("./src/index").DbTable>;
	DbGateway: DurableObjectNamespace<import("./src/index").DbGateway>;
	DbView: DurableObjectNamespace<import("./src/index").DbView>;
	AUTH_AGENT: Fetcher /* auth-agent */ | Fetcher /* auth-agent-local */ | Fetcher /* auth-agent-test */ | Fetcher /* auth-agent-preview */;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DbAgent" | "DbCollection" | "DbTable" | "DbGateway" | "DbView";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPOSE_OPERATOR_API" | "DEMO_MODE" | "DEMO_TTL_HOURS" | "SENTRY_DSN" | "SENTRY_ENV" | "TRUSTED_ORIGINS" | "REGION_OVERRIDE_HEADER" | "SIBLING_SPAWN_SOCKETS" | "SIBLING_ROUTING_TTL_MS">> {}
}
