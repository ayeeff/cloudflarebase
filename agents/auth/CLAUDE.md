...
- `GET /console/me` (console instance only): session + org memberships + pending invitations in ONE round trip, with a lazy personal-org heal for accounts predating organizations. The dashboard guard calls this per request over the service binding.
