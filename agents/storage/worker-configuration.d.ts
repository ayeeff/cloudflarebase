/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 94eefcbffb77768c1831cfe7c56b353c)
// Runtime types generated with workerd@1.20260811.1 2026-07-10 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	BUCKET?: R2Bucket;
	EXPOSE_OPERATOR_API: "true";
	TRUSTED_ORIGINS: "http://localhost:5173" | "";
	STORAGE_SERVE_DOMAIN?: "cdn.cfbase.test" | "cdn.cloudflarebase.com" | "";
	STORAGE_SERVE_HOST_HEADER?: "true";
	SENTRY_DSN: "";
	SENTRY_ENV: "development" | "test" | "production" | "preview";
	StorageAgent: DurableObjectNamespace<import("./src/index").StorageAgent>;
	StorageBucket: DurableObjectNamespace<import("./src/index").StorageBucket>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "StorageAgent" | "StorageBucket";
	}
	interface LocalEnv {
		BUCKET: R2Bucket;
		EXPOSE_OPERATOR_API: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPOSE_OPERATOR_API" | "TRUSTED_ORIGINS" | "STORAGE_SERVE_DOMAIN" | "STORAGE_SERVE_HOST_HEADER" | "SENTRY_DSN" | "SENTRY_ENV" | "STORAGE_SERVE_DOMAIN_ROUTED">> {}
}
